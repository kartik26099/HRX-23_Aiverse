...
const nextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY: process.env.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY || 'pk_test_bW9kZXN0LWJ1cnJvLTIzLmNsZXJrLmFjY291bnRzLmRldiQ',
    CLERK_SECRET_KEY: process.env.CLERK_SECRET_KEY || 'sk_test_p6p9yol58mx3UpoFKGGSUsTDl9R7zC9XwgPs5wS398',
  },
}
